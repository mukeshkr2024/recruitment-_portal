...
app.use(
    cors({
        origin: ["http://localhost:3000", "http://localhost:5173", "http://localhost:4173", "https://assessment-client-sigma.vercel.app", "http://82.112.227.200:4173", "http://careers.codingcommando.in", "https://careers.codingcommando.in"],
        credentials: true,
